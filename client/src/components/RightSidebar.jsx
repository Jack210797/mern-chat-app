...
const RightSidebar = () => {
  ...
  //Get all the images from the messagees and set them to state
  useEffect(() => {
      ...
      >
        <div className="pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto">
          ...
          <h1 className=" text-xl px-10 font-medium mx-auto flex items-center gap-2">
            {onlineUsers.hasOwnProperty(selectedUser._id) && <p className="w-2 h-2 rounded-full bg-green-500"></p>}
